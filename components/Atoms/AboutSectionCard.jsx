...
export const AboutSectionCard = ({title, text, src, style = 'h-full'}) => {
  return (
    <FadeInSection className={`${style} w-full flex flex-col-reverse md:flex-row items-center mb-[45px] lg:mb-0 pb-6 md:pb-0 max-w-[1135px] mx-auto md:h-[470px] bg-[#F2F2F2]`}>
        <div className="w-full md:w-1/2 md:h-full px-3 md:px-8 pt-6 md:pt-0 flex flex-col justify-center gap-4">
